...
2. `input_dir`: The directory containing the images (in nifti, either .nii or .nii.gz) to process. Please keep in mind the [naming conventions](https://github.com/ENHANCE-PET/MOOSE?tab=readme-ov-file#naming-conventions-for-nifti-files-) 
